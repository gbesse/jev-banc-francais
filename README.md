...
[![Tests](https://github.com/gbesse/jev-banc-francais/actions/workflows/test.yml/badge.svg)](https://github.com/gbesse/jev-banc-francais/actions/workflows/test.yml) [MIT](LICENSE) · Node.js 22+ · Public alpha
...
```sh
git clone https://github.com/gbesse/jev-banc-francais.git
cd jev-banc-francais
npm install
npm run demo
```
...
The repository ships only synthetic examples and makes no comparative model claim. Useful conclusions require a licensed, representative held-out dataset.
